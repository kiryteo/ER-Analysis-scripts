...
sns.stripplot(x=climp_conf_Area, color='red', label='Confocal', ax=axes[0])
sns.stripplot(x=climp_sted_Area, color='blue', label='STED', ax=axes[0])
sns.stripplot(x=climp_synth_Area, color='green', label='Synth', ax=axes[0])
axes[0].set_title('iwuegfiwu', size=10)
axes[0].set_xlabel('Area', fontsize=10)
axes[0].legend(loc='upper right')

sns.stripplot(x=control_conf_Area, color='red', label='Confocal', ax=axes[1])
sns.stripplot(x=control_sted_Area, color='blue', label='STED', ax=axes[1])
sns.stripplot(x=control_synth_Area, color='green', label='Synth', ax=axes[1])
axes[1].set_title('iwuegfiwu', size=10)
axes[1].set_xlabel('Area', fontsize=10)
axes[1].legend(loc='upper right')

sns.stripplot(x=rtn_conf_Area, color='red', label='Confocal', ax=axes[2])
sns.stripplot(x=rtn_sted_Area, color='blue', label='STED', ax=axes[2])
sns.stripplot(x=rtn_synth_Area, color='green', label='Synth', ax=axes[2])
axes[2].set_title('iwuegfiwu', size=10)
axes[2].set_xlabel('Area', fontsize=10)
