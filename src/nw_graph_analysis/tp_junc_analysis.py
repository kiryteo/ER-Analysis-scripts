...
def get_nodes_on_er_input():
    ...
    newps = [ps[j] for j, val in enumerate(d) if val[1] > 2]
    # print(newps)
...
def get_all_edges():
    ...
    # input = imageio.imread('/localhome/asa420/ER-Analysis-scripts/Figure1/A1_t0.png')
    input = imageio.imread('/localhome/asa420/ER-Analysis-scripts/Figure3-FuzIso/C12_t0_ch0.png')
    # input = input[::-1]
    # ske = imageio.imread('/localhome/asa420/MIAL/data/confocal_movies/ATL/new_op_jul/skel/A1/A1_decon_t000_ch00_skel.png')
    ske = imageio.imread('/localhome/asa420/ER-Analysis-scripts/Figure3-FuzIso/C12_t0_ch0_loc2_enhance_skel.png')
...
def get_relevant_edges():
    ...
    # ske = imageio.imread('/localhome/asa420/MIAL/data/confocal_movies/ATL/new_op_jul/er_mean_proc/atl1_er_mean_proc_enhance_skel.png')

    # ske = imageio.imread('/localhome/asa420/MIAL/data/confocal_movies/Climp/new_op_jul/er_mean_proc/climp12_er_mean_proc_enhance_skel.png')
    ske = imageio.imread('/localhome/asa420/MIAL/data/confocal_movies/Climp/new_op_jul/skel/C12/C12_decon_t000_ch00_skel.png')
    ...
    graph = sknw.build_sknw(ske, multi=True, iso=False)
    # graph_multi = sknw.build_sknw(ske, multi=True, iso=False)

    # print(graph_multi.edges())
    # print(graph.edges())
    # exit()
    # G = nx.Graph()
    ...
    # print(node_set[relevant_node_list[5]])
    ...
    return nodes, relevant_node_list, relevant_edge_terminals
    # plt.close()

#######################################################
#######################################################
#
# nodes, relevant_node_list, relevant_edge_terminals = get_relevant_edges()
#
# print(nodes[0])
# exit()
#
# newl = []
# for each in relevant_node_list:
#     dt = {}
#     dt[each] = nodes[each]
#     newl.append(dt)
#
...
# exit()
# # print(nps)
# print(relevant_node_list)
# print(relevant_node_list[0])
# exit()
# new_nps = np.array([nodes[i]['o'] for i in relevant_node_list])
# print(new_nps)
# exit()
#
# print(relevant_edge_terminals)
# exit()
...
#
# for each in nps:
#     new_nps.append((each[0], each[1]))
#
# for each in relevant_edge_terminals:
#     new_rel_edges.append((each[0], each[1]))
#
#
# # print(new_rel_edges)
# # exit()
# G = nx.Graph()
# G.add_nodes_from(new_nps)
# G.add_edges_from(new_rel_edges)
# # print(G.degree)
# nodes = G.nodes()
# print(nodes(1, 12))
# ps = np.array([nodes[i]['o'] for i in nodes])
