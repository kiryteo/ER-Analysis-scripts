...
def graph_features(group, series_num):
    ...
    # print(nx.degree_assortativity_coefficient(conn_graph))
    # print(nx.degree_pearson_correlation_coefficient(conn_graph))

    # avg_nbr_deg = nx.average_neighbor_degree(conn_graph)

    # plt.hist(list(avg_nbr_deg.values()))
    # plt.show()
    # print(nx.average_degree_connectivity(conn_graph))
    # print(nx.degree_centrality(conn_graph))
    ...
    # print(nx.closeness_centrality(conn_graph))

    # not for multi
    # print(nx.communicability_betweenness_centrality(conn_graph))

    # not implemented for multigraph
    # print(nx.eigenvector_centrality(conn_graph))

    # print(list(nx.enumerate_all_cliques(conn_graph)))
    # deg_one_nodes, deg_two_nodes, high_deg_nodes = get_updated_degree_nodes(conn_graph)

    print(nx.laplacian_matrix(conn_graph))


graph_features('ATL', 3)
exit()
