...
STED = imread(f'{home}/MIAL/blob-analysis/1_Series012_decon_merged_patch10_sted.png')

KM_op = imread(f'{home}/MIAL/blob-analysis/1_Series012_decon_merged_patch10_sted_entropyKapurMultiTh.jpg')

SM_op = imread(f'{home}/MIAL/blob-analysis/1_Series012_decon_merged_patch10_sted_singh.jpg')

beads_op = imread(f'{home}/MIAL/blob-analysis/1_Series012_decon_merged_patch10_sted_beads.png')
