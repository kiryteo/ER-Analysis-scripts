...
def create_erode_img():
    for i in range(7, 17):
        dirname = f'/localhome/asa420/MIAL/data/live-cell-movies/COSKDELRTN/COSKDELRTN/Decon/Series0{i:02d}_decon_converted/std/*'
