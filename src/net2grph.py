...
for i in range(100):
    ...
    ske = imageio.imread(f'/localhome/asa420/MIAL/data/confocal_movies/ATL/new_op_jul/skel/A4/A4_decon_t0{i:02d}_ch00_skel.png')
...
for i in range(100):
    ...
    # plt.show()
    plt.axis('off')
    plt.savefig(f'/localhome/asa420/MIAL/data/confocal_movies/ATL/new_op_jul/graphs/A4/A4_decon_t0{i:02d}_ch00_graph.png', bbox_inches='tight', pad_inches=0)
...
for i in range(1):
    ske = imageio.imread(f'/localhome/asa420/MIAL/data/confocal_movies/Climp/skel/C29/C29_decon_t0{i:02d}_ch00_skel.png')
    ...
    overlay_image = cv2.imread(f'/localhome/asa420/MIAL/data/confocal_movies/Climp/files/C29_decon_t0{i:02d}_ch01_std.png')
