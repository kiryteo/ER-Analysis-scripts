...
# ctrl_brpts frame
ctrl_ref_junctions = imageio.imread(home + '/MIAL/aggregation-with-median/Control/avg/brpts/series6-avg_brpts.png')
# ctrl_files_dir
ctrl_files = glob.glob(home + '/MIAL/live-cell-movies/COSKDEL/COSKDEL/Decon/Series006_decon_converted/std/*')

# climp_brpts_frame
climp_ref_junctions = imageio.imread(home + '/MIAL/aggregation-with-median/Climp/avg/brpts/ClimpSeries4-avg_brpts.png')
# climp_files_dir
climp_files = glob.glob(home + '/MIAL/live-cell-movies/COSKDELCLIMP/COSKDELCLIMP/Decon/Series004_decon_converted/std/*')

# rtn_brpts_frame
rtn_ref_junctions = imageio.imread(home + '/MIAL/aggregation-with-median/RTN/avg/brpts/RTNSeries14-avg_brpts.png')
# rtn_files_dir
rtn_files = glob.glob(home + '/MIAL/live-cell-movies/COSKDELRTN/COSKDELRTN/Decon/Series014_decon_converted/std/*')
